...
- **Layout** — *4-up sheet* (four cards per Letter/A4 page), *Single
  ...
  *Booklet (6×8)* — several holes to a 6×8 page with a two-player
  footer, or *Continuous (6×8)* — six holes packed onto one shared dot
  grid at varied angles with rough flowing between them, closest to the
  printed Paper Apps GOLF pad.
